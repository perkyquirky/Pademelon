...
1. Claude Sonnet was used for generating an initial POC.
   I was not sure if this would be possible, I thought it might, but I did not want to invest a few months of my spare time to find out it would not. 

2. I am currently using GLM 5.3-FLASH with OpenCode